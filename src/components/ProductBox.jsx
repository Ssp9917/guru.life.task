...
const ProductBox = ({index}) => {
  ...
  return (
    <animated.div style={styles}  className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
      <a
